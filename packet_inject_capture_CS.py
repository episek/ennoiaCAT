...
#pcap_file_in  = "test_ip36to37_100000p.pcap"
pcap_file_in  = "test_ip36to37_9000B.pcap"    # input PCAP file to replay
#pcap_file_in  = "test_ip36to37.pcap"    # input PCAP file to replay
pcap_file_out = "capture_output1.pcapng" # pyshark saves here
